            ...
            __WEBPACK_IMPORTED_MODULE_2_jquery__(window).scroll(function () {
                ...
                scrollLink.each(function () {
                    ...
                    if (scrollbarLocation >= 250) {
                        __WEBPACK_IMPORTED_MODULE_2_jquery__('.navbar').css('background', 'rgba(23,146,186,0.5)');
                        ...
                        __WEBPACK_IMPORTED_MODULE_2_jquery__('.navbar').css('background', 'rgba(244, 241, 241, 0.50)');
                        /*$('.navbar-nav > li > a').css('color','black');
                        $('.navbar-nav > li > a').hover(
                          function() {
                            $(this).css('color','blue');
