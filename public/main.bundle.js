...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_auth_service__ = __webpack_require__("../../../../../src/app/services/auth.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery__ = __webpack_require__("../../../../jquery/index.js");
    ...
    */
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_2_jquery__(document).ready(function () {
            var scrollLink = __WEBPACK_IMPORTED_MODULE_2_jquery__('.scroll');
            // Smooth scrolling
            scrollLink.click(function (e) {
                e.preventDefault();
                __WEBPACK_IMPORTED_MODULE_2_jquery__('body,html').animate({
                    scrollTop: __WEBPACK_IMPORTED_MODULE_2_jquery__(this.hash).offset().top
                }, 1000);
            ...
            __WEBPACK_IMPORTED_MODULE_2_jquery__(window).scroll(function () {
                var scrollbarLocation = __WEBPACK_IMPORTED_MODULE_2_jquery__(this).scrollTop();
                scrollLink.each(function () {
                    var sectionOffset = __WEBPACK_IMPORTED_MODULE_2_jquery__(this.hash).offset().top - 60;
                    console.log("1:" + sectionOffset + "2:" + scrollbarLocation);
                    if (scrollbarLocation >= 250) {
                        __WEBPACK_IMPORTED_MODULE_2_jquery__('.navbar').css('background', 'grey');
                        ...
                        __WEBPACK_IMPORTED_MODULE_2_jquery__('.navbar-nav').find('li.active').css('font-size', '30px');
                        __WEBPACK_IMPORTED_MODULE_2_jquery__('.navbar-header > a').css('color', 'white');
                    }
                    else {
                        __WEBPACK_IMPORTED_MODULE_2_jquery__('.navbar').css('background', 'white');
                        /*$('.navbar-nav > li > a').css('color','black');
                        $('.navbar-nav > li > a').hover(
                          function() {
                            $(this).css('color','blue');
                        ...
                        __WEBPACK_IMPORTED_MODULE_2_jquery__('.navbar-nav').find('li.active').css('color', 'blue');
                        __WEBPACK_IMPORTED_MODULE_2_jquery__('.navbar-header > a').css('color', 'black');
                    }
                    /*
...
module.exports = "\n<nav class=\"navbar navbar-default\">\n    <div class=\"container\" *ngIf=\"!authService.isTest() || !authService.isEvaluate()\">\n        <div class=\"navbar-header\">\n           <button type=\"button\" class=\"navbar-toggle\" data-toggle=\"collapse\" data-target=\"#myNavbar\">\n              Menu\n           </button>\n            <a class=\"navbar-brand\" href=\"#\">Career Skills Enhancement</a>\n        </div>\n        \n        <div class=\"collapse navbar-collapse\" id=\"myNavbar\">\n            <ul class=\"nav navbar-nav navbar-left\">\n              <li routerLinkActive=\"active\" [routerLinkActiveOptions]=\"{exact:true}\"><a routerLink=\"/\">Home</a></li>\n              <!--<li *ngIf=\"authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a routerLink=\"/login\">தமிழ்</a></li>\n              <li *ngIf=\"authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a routerLink=\"/profile\">Learn</a></li>-->\n            </ul>\n\n            <ul class=\"nav navbar-nav navbar-right\">\n                <li *ngIf=\"authService.loggedIn() && !authService.isAdmin()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a routerLink=\"/dashboard\">Dashboard</a></li>\n                <li *ngIf=\"authService.loggedIn() && authService.isAdmin()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a routerLink=\"/result\">Users</a></li>\n                <li *ngIf=\"authService.loggedIn() && authService.isAdmin()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a routerLink=\"/report\">Tickets</a></li>\n                <li *ngIf=\"authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a routerLink=\"/profile\">Profile</a></li>\n\n                <li *ngIf=\"!authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a routerLink=\"/login\">Login</a></li>\n                <li *ngIf=\"!authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a routerLink=\"/register\">Register</a></li>\n                <li *ngIf=\"authService.loggedIn()\"><a href=\"#\" (click)=\"onLogoutClick()\">Logout</a></li>\n            </ul>\n        </div>\n        \n    </div>\n    \n  \n</nav>\n"
...
module.exports = "<div *ngIf=\"tickets\">\n  <div *ngFor=\"let ticket of tickets;let i=index;\">\n      <div class=\"panel {{ticket.priority}}\">\n          <div class=\"panel-heading\">\n            <h4 class=\"panel-title\">\n              <a data-toggle=\"collapse\" href=\"#{{i}}\">{{ticket.problem}}</a>\n              <button><i class=\"fa fa-trash\" (click)=\"deleteTicket(ticket.problem,ticket.email)\" style=\"float:right;margin-right:10px;color:red\"></i></button>\n              <button><i class=\"fa fa-close\" (click)=\"uncheck(ticket.problem,ticket.email)\" style=\"float:right;margin-right:10px;color:orange;\"></i></button>\n              <button><i class=\"fa fa-check\" (click)=\"check(ticket.problem,ticket.email)\" style=\"float:right;margin-right:10px;color:green;\"></i></button>\n            </h4>\n          </div>\n          <div id=\"{{i}}\" class=\"panel-collapse collapse\">\n            <div class=\"panel-body\">{{ticket.description}}</div>\n            <div class=\"panel-footer\">\n              <div class=\"row\">\n                  <div class=\"col-xs-12 col-md-3\"><i class=\"fa fa-user\" style=\"margin:10px;font-size:20px;\"></i>{{ticket.name}}</div>\n                  <div class=\"col-xs-12 col-md-3\"><i class=\"fa fa-envelope\" style=\"margin:10px;font-size:20px;\"></i>{{ticket.email}}</div>\n                  <div class=\"col-xs-12 col-md-3\"><i class=\"fa fa-mobile\" style=\"margin:10px;font-size:20px;\"></i>{{ticket.contact}}</div>\n                  <div class=\"col-xs-12 col-md-3\"><i class=\"fa fa-calendar\" style=\"margin:10px;font-size:20px;\"></i>{{ticket.date}}</div>\n              </div> \n            </div>\n          </div>\n        </div>\n  </div>\n</div>\n"
...
module.exports = "<div *ngIf=\"users\">\n  <div *ngFor=\"let user of users;let i=index;\">\n      <div class=\"panel panel-default\">\n          <div class=\"panel-heading\">\n            <h4 class=\"panel-title\">\n              <a data-toggle=\"collapse\" href=\"#{{i}}\">{{user.name}}</a>\n            </h4>\n          </div>\n          <div id=\"{{i}}\" class=\"panel-collapse collapse\">\n            <div class=\"panel-body\">\n              <div class=\"row\">\n                <div class=\"col-xs-12 col-md-6\"><i class=\"fa fa-envelope\" style=\"margin:5px;font-size:20px;\"></i>{{user.email}}</div>\n                <div class=\"col-xs-12 col-md-6\"><i class=\"fa fa-mobile\" style=\"margin:5px;font-size:20px;\"></i>{{user.contact}}</div>\n              </div>\n            </div>\n          </div>\n        </div>\n  </div>\n</div>\n          "
...
/***/ "../../../../../src/assets/img1_2.jpg":
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "img1_2.45728bed8b8b020faa7a.jpg";
